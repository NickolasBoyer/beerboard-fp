<template>
  <div class="tile">
    <div class="tile__section"> 
      ...
      <button class="tile__section__button">Buy it!</button>
    </div>
  ...
  data () {
    return {
      tiles: {
        left: {
          title: "Free",
          content: "It really is <i>free</i>, amazing! Who would have thought, this amazing tool"
        },
        right: {
          title: "€1/month",
          content: "<ul><li>More features than you could i i ever dream of</li><li>No so many features</li></ul>"
        }
      }
    }
  }
